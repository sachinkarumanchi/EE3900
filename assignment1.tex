...
\end{lstlisting}
\section*{Problem(Ramsey/1.1 Points/Q.2(b))}
Find the length of $\vec{PQ}$ for
$$\vec{P} = \myvec{4\\3} \ \text{and} \ \vec{Q} = \myvec{-2\\2}$$
\section*{Solution}
Let $d$ be the distance between $\vec{P}$ and $\vec{Q}$\\
Therefore, $d$ is given by
\begin{align}
    d&=\norm{\vec{P}-\vec{Q}}\label{eq1}
\end{align}
Let $\vec{R}$ be $\vec{P}-\vec{Q}$
\begin{align}
    \vec{R}&=\myvec{4\\3}-\myvec{-2\\2}\\
    \vec{R}&=\myvec{6\\1}\label{eq2}
\end{align}    
...
\begin{align}
    ...
    d&\approx 6.0827 
\end{align}
$\therefore$The length of $\vec{PQ}$ is close to 6.0827
\begin{figure}[h]
