...
\begin{lstlisting}
https://github.com/sachinkarumanchi/EE3900/blob/main/assignment4/asiignment4.ipynb
\end{lstlisting}
...
\begin{align}
    ...
    \implies \frac{\myvec{-m & 1}\myvec{-3 \\ 1}}{\sqrt{10}\times \norm{m}}&=\frac{\myvec{-m & 1}\myvec{-1 \\ 2}}{\sqrt{5}\times \norm{m}}
\end{align}
\begin{align}
