...
Express the following Matrix as a sum of a symmetric and a skew symmetric matrix:
$$\myvec{6&-2&2\\-2&3&-1\\2&-1&3}$$
\section*{Solution}
Let A be the given matrix\\
\begin{align}
    \Vec{A}&=\myvec{6&-2&2\\-2&3&-1\\2&-1&3}\\
    \Vec{A}^T&=\myvec{6&-2&2\\-2&3&-1\\2&-1&3}\\
    \implies \Vec{A}&=\Vec{A}^T\label{eq1}
\end{align}
Since, $\Vec{A}$ is a symmetric matrix the skew symmetric matrix would be 0

$\therefore \Vec{A}=\Vec{B}+\Vec{C}$
\begin{align}
    \myvec{6&-2&2\\-2&3&-1\\2&-1&3}&=\myvec{6&-2&2\\-2&3&-1\\2&-1&3}+\myvec{0&0&0\\0&0&0\\0&0&0}
\end{align}
Here, $\Vec{B}$ is the symmetric matrix and $\Vec{C}$ is the skew symmetric matrix.
\end{document}
